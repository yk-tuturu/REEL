...
public class menuTransition : MonoBehaviour
{
    ...
    public void StartNewGame()
    {
        ...
        iTween.ValueTo(panel, iTween.Hash("from", 0f, "to", 1f, "time", 2.9f, "onupdate", "updateColor", "onupdatetarget", this.gameObject, "oncomplete", "loadNewScene", "oncompletetarget", this.gameObject));
    }
    ...
    public void LoadGame(int index)
    {
        bgmScript.instance.SetParameter(1f);
        FMODUnity.RuntimeManager.PlayOneShot(uiMainMenuStartGameEvent, transform.position);
        iTween.ValueTo(panel, iTween.Hash("from", 0f, "to", 1f, "time", 2.9f, "onupdate", "updateColor", "onupdatetarget", this.gameObject, "oncomplete", "loadSaveFile", "oncompletetarget", this.gameObject, "oncompleteparams", index));
    }
